...
export default function Edit({ book }) {
    // Format dates for HTML date inputs (need YYYY-MM-DD format)
    const formatDateForInput = (dateString) => {
        if (!dateString) return '';
        // If it's already in YYYY-MM-DD format, return as is
        if (/^\d{4}-\d{2}-\d{2}$/.test(dateString)) return dateString;
        // Otherwise extract the date part from ISO datetime
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        issue_date: formatDateForInput(book.issue_date),
        return_date: formatDateForInput(book.return_date),
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="max-w-2xl mx-auto space-y-4">
                ...
                <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-amber-600 via-orange-600 to-red-600 p-6 shadow-xl">
                    ...
                    <div className="relative flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-orange-100">Update book information</p>
                        </div>
                    </div>
                </div>
                ...
                <Card className="border-0 shadow-lg">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update book information and track your reading progress
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setData('current_page', e.target.value)}
                                        placeholder="0"
                                        min="0"
                                        className="focus:ring-green-500"
                                    />
                                    <InputError message={errors.current_page} />
                                </div>
                            ...
                            <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4">
                                <Link href={route('books.show', book.id)} className="flex-1">
